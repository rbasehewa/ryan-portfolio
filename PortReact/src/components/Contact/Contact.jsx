    ...
    <footer className={styles.container} id="contacts">
      ...
      <div className={styles.bookingSection}>
        <h3 className={styles.bookingTitle}>
          Ready to chat about automation & AI?
        </h3>
        <p className={styles.bookingSubtitle}>
          Pick a time that works for you – I’ll send a calendar invite with a
          video call link.
        </p>

        <div className={styles.bookingFrameWrapper}>
          <iframe
            title="Book a call with Ryan"
            src="https://calendar.app.google/2tNQsGjBzHzezeBYA"
            className={styles.bookingFrame}
            loading="lazy"
          />
        </div>
      </div>
